    ...
    <div className="min-h-screen bg-gray-950 text-gray-50 dark:bg-gray-950 dark:text-gray-50">
      ...
      <main>
        <section className="py-16 bg-white dark:bg-black">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-lg text-gray-400">Discover the resources, tools, and connections you need to grow your startup.</p>
        ...
        <section className="py-16 bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-lg text-gray-400">Connect with other entrepreneurs, investors, and industry experts.</p>
      ...
      <footer className="bg-gray-950 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 py-6 text-center text-gray-400">© 2024 Startup Ecosystem Integrator. All rights reserved.</div>
        </div>
      </footer>
    </div>
  );
